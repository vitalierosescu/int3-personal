...
<header class="header container grid">
  <div class="header-heading">
    ...
    <div class="btn btn-cta">Start creating</div>
  </div>
  ...
  <div class="table">
    ...
    <section class="lottie-env header-holy">
...
<section class="tools container">
  ...
  <ul class="tools-list">
    <li class="tools-item">
      <img src="./assets/img/tools-crocs.svg" height="100px" alt="">
    ...
    <li class="tools-item">
      <img src="./assets/img/paint.svg" height="100px" alt="">
      <p class="body-text">verf</p>
    </li>
    <li class="tools-item">
      <img src="./assets/img/rollement.svg" height="100px" alt="">
      <p class="body-text">2x rollend lager</p>
    </li>
    <li class="tools-item">
      <img src="./assets/img/soles.svg" height="100px" alt="">
      <p class="body-text">1 paar zolen</p>
    </li>
    <li class="tools-item">
      <img src="./assets/img/maker-bol.svg" height="100px" alt="">
      <p class="body-text">verf</p>
    ...
    <li class="tools-item">
      <img src="./assets/img/cuttermes.svg" height="100px" alt="">
      <p class="body-text">cuttermes</p>
    </li>
    <li class="tools-item">
      <img src="./assets/img/maker-bol.svg" height="100px" alt="">
      <p class="body-text">verf</p>
      ...
      <div class="tut1-heading">
        ...
        <div>
          ...
          <div class="tut1-instruction">
            <p class="tut1-instruction-text">Hou de kraan boven de vuile crocs.</p>
            <img class="tut1-hand" src="./assets/img/lil-hand.svg" alt="klein handje die aanwijst waar je moet draggen/swipen">
          </div>
        ...
        <section class="lottie-env wash-lottie-section" data-aos="fade-top" data-aos-duration="2000" data-aos-once="true">
          <div id="lottie" class="wash-lottie"></div>
      </div>
</section>
</div>
</article>
...
<article class="tut2">
  <div class="tut2-container container">
    ...
    <div class="autopsie-lottie-section">
      ...
      <div class="tut2-croc-container">
        <div class="croc-shoc-container">
          <img class="croc-shoc-man" src="./assets/img/croc-shoc.svg" alt="">
          <img class="hand" src="./assets/img/hand.svg" data-aos="fade-right" data-aos-duration="2000" alt="">
        </div>
        <div id="autopsie-lottie"></div>
      </div>
    </div>
  </div>
</article>
  ...
  <div class="container">
    <div class="tut4-heading">
      ...
      <div class="tut4-header">
        ...
        <p class="tut4-intro">Haal al het verf maar uit je kast, want je Crocs verdienen een nieuw kleurtje. Selecteer een kleur voor elk onderdeel van de crocs om zo te zien welke kleuren combo’s jij leuk vindt!</p>
      </div>
    </div>
...
<div class='infinite-block'>
  <p class="infinite-content">

    <span class="loop1">&nbsp;<span class="almost-outline">almost there</span><span class=almost-full>almost there</span><span class="almost-outline">almost there</span><span class=almost-full>almost there</span><span class="almost-outline">almost there</span><span class=almost-full>almost there</span><span class="almost-outline">almost there</span><span class=almost-full>almost there</span></span>

    <span class="loop2">&nbsp;<span class="almost-outline">almost there</span><span class=almost-full>almost there</span><span class="almost-outline">almost there</span><span class=almost-full>almost there</span><span class="almost-outline">almost there</span><span class=almost-full>almost there</span><span class="almost-outline">almost there</span><span class=almost-full>almost there</span></span>
  </p>
</div>
...
<article class="tut5 grid">
  <div class="tut5-container container full-width">
    <div class="tut-number tut-number5 shadow">05</div>
    <h3 class="h3 text-center">It's coming togheter.</h3>
    <p class="tut5-text text-center">
  ...
  <section class="lottie-env env-three smiley-lottie full-width">
    <div id="lottie-three" class="">
      <div>
  </section>
  <!-- <div class="test full-width" data-aos="fade-top" data-aos-duration="2000" data-aos-offset="500" data-aos-once="true">
...
<!-- step 6 - start -->
<article class="tut6 grid container">
  <div class="tut6-heading">
    <div class="tut-number tut-number6 shadow">06</div>
    <h3 class="">No sole is wasted.</h3>
    <p>Ga opzoek naar een paar oude schoenen van je en haal de zolen eruit. Dit zal ons enorm helpen om comfortabeler te heleren.</p>
  </div>
  <img class="tut6-old" src="./assets/img/old.svg" alt="">
  <img class="tut6-gangster" src="./assets/img/gangster.svg" alt="">
</article>
...
<article class="tut-end">
  <div class="tut-end-container container grid">
    ...
    <img class="tut-end-img" src="./assets/img/insta1.png" alt="">
  </div>
</article>
</section>
...
<section class="maker-section">
  <article class="maker grid container">
    <img class="maker-img" src="./assets/img/promo.png" alt="">
    <div class="maker-heading">
      <h2 class="maker-title">Maker Faire Gent</h2>
      <p class="maker-date">30 april - 1 mei - 2 mei</p>
      <p class="maker-text">
        Altijd gedreven om het nieuwe te ontdekken en zelf zaken uit te proberen? Voel jij je in je element op het vlak van creatief knutselen? Jij moet zeker een Maker Spirit hebben.
        <br> <br>
        Gelukkig voor jou is hier een festival voor gemaakt, namelijk de Maker Fair. Drie dagen lang kan je hier je mooiste creatie tentoonstellen aan de buitenwereld. Robotarmen, een vuurspuwende draak, een touwtjes-springende pinguïn, … Het hoort hier allemaal thuis.
      </p>
